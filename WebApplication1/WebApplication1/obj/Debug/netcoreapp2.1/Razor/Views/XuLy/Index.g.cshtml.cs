#pragma checksum "C:\Projects\Seminar\WebApplication1\WebApplication1\Views\XuLy\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0f4129d8fd28c5d1e94b83e4609ac7f6d9edd8cc"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0f4129d8fd28c5d1e94b83e4609ac7f6d9edd8cc", @"/Views/XuLy/Index.cshtml")]
...
");
            ...
            EndContext();
            BeginContext(908, 955, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "47871c4bfe4a42e8b4f884fac8d8b26d", async() => {
                BeginContext(934, 922, true);
                WriteLiteral(@"
            ...
            EndContext();
            BeginContext(2091, 259, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "84770a421c21473aaff9afc09b4b5993", async() => {
                BeginContext(2122, 221, true);
...
<script src=""https://ajax.googleapis.com/ajax/libs/jquery/3.");
            WriteLiteral(@"4.1/jquery.min.js""></script>
...
<script>
        ...
        for (let i = 0; i < sl; i++) {
            ...
            $(""#vatco"").append(`
                <div class=""col-md-6"">
                    ...
                    <input placehol");
            WriteLiteral(@"der=""Giá trị vật thứ ${i + 1}"" type=""number"" class=""form-control giatri${i}""></div>
                </div>`
            );
        }
   ...
   ");
    ...
    $(""#btnRandom"").click(function (e) {
        ...
        $.ajax({
            url: ""/XuLy/RandomDynamicPlanningALgorithm"",
            type: ""POST"",
            data: {
                ""txttrongluong"": parseInt($(""#trongluong"").val()),
                ""txtsoluong"": parseInt($(""#soluong"").val())
